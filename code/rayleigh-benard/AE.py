...
file = np.load('../../scr16_mshiel10/kontolati/benard/Data/Benard_data_nx_128_nz_128_nt_100_0-200.npz')
inputs_1, outputs_1 = file['inputs'], np.array((file['outputs']))

file = np.load('../../scr16_mshiel10/kontolati/benard/Data/Benard_data_nx_128_nz_128_nt_100_200-400.npz')
inputs_2, outputs_2 = file['inputs'], np.array((file['outputs']))

file = np.load('../../scr16_mshiel10/kontolati/benard/Data/Benard_data_nx_128_nz_128_nt_100_400-600.npz')
inputs_3, outputs_3 = file['inputs'], np.array((file['outputs']))

file = np.load('../../scr16_mshiel10/kontolati/benard/Data/Benard_data_nx_128_nz_128_nt_100_600-800.npz')
inputs_4, outputs_4 = file['inputs'], np.array((file['outputs']))

#inputs = np.concatenate((inputs_1, inputs_2, inputs_3, inputs_4), axis=0).reshape(n, nx*ny) # flatten
#outputs = np.concatenate((outputs_1, outputs_2, outputs_3, outputs_4), axis=0)
